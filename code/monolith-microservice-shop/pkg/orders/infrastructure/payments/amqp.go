...
import (
	...
	payments_amqp_interface "github.com/MaksimDzhangirov/three-dots/code/monolith-microservice-shop/pkg/payments/interfaces/amqp"
...
func NewAMQPService(url, queueName string) (AMQPService, error) {
	...
	return AMQPService{queue: q, channel: ch}, nil
}
