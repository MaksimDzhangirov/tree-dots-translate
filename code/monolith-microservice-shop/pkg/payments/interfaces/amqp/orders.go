...
import (
	...
	"github.com/MaksimDzhangirov/three-dots/code/monolith-microservice-shop/pkg/payments/application"
...
func NewPaymentsInterface(url string, queueName string, service application.PaymentsService) (PaymentsInterface, error) {
	...
	return PaymentsInterface{conn: conn, queue: q, channel: ch, service: service}, nil
}
