...
var UserWhere = struct {
	...
	LastIP:       whereHelpernull_String{field: "`users`.`last_ip`"},
...
type userR struct {
	Emails EmailSlice `boil:"Emails" json:"Emails" toml:"Emails" yaml:"Emails"`
}
...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "password_hash", "last_ip", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"first_name", "last_name", "password_hash", "last_ip", "created_at", "updated_at"}
...
func (userL) LoadEmails(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`emails`),
		qm.WhereIn(`emails.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
