...
import (
	"context"
	"fmt"
	"github.com/MaksimDzhangirov/three-dots/part15/internal/common/client/users"
	"net/http"
	"os"
	"strings"
	"testing"
	...
	"github.com/MaksimDzhangirov/three-dots/part15/internal/common/client/trainer"
	"github.com/MaksimDzhangirov/three-dots/part15/internal/common/client/trainings"
	"github.com/stretchr/testify/require"
)

func authorizationBearer(token string) func(ctx context.Context, w *http.Request) error {
...
func NewUserHTTPClient(t *testing.T, token string) UsersHTTPClient {
