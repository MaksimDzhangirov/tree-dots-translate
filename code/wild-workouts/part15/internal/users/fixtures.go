...
import (
	...
	"github.com/MaksimDzhangirov/three-dots/part15/internal/common/client"
...
func loadFixtures() {
	...
	if mockAuth, _ := strconv.ParseBool(os.Getenv("MOCK_AUTH")); !mockAuth {
		...
		// частичное копирование из web/src/repositories/user.js
		attendeeUUIDs = []string{"2"}
	}

	for {
		err = setAttendeeTrainingAmount(attendeeUUIDs)
		if err == nil {
			break
		}
...
func setAttendeeTrainingAmount(attendeeUUIDs []string) error {
