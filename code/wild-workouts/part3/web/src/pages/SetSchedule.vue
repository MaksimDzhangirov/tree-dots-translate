<template>
  <app-layout>
    <div class="py-5 text-center">
      ...
      <br>
      <p class="lead">Below is an example form build entirely with Bootstrap's form controls. Each required form
      group has a validation state that can be triggered by attempting to submit the form without completing it.</p>

      <div class="btn-group btn-group-toggle">
        <label class="btn btn-online-dark" v-for="period in periods" :key="period.from+period.to"
