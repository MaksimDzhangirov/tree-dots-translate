<template>
  <app-layout>
    <div class="py-5 text-center">
      ...
      <br>
      <p class="lead">Below is an example form build entirely with Bootstrap's form controls. Each required form group
        ...
        <form class="needs-validation" @submit.prevent="scheduleNewTraining" novalidate>
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <select class="custom-select" size="7" id="day" v-model="trainingData.date" v-on:change="trainingDayChange">
                <option v-for="day in calendar"
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="custom-select" size="7" id="hour" v-model="trainingData.hour">
                <template v-for="hour in availableHours">
                  <option :key="formatHour(hour.hour)"
