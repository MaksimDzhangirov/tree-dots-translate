...
import (
	...
	"github.com/MaksimDzhangirov/three-dots/code/wild-workouts/part14/internal/trainer/domain/hour"
	"github.com/MaksimDzhangirov/three-dots/part14/internal/common/errors"
)
