...
import (
	...
	"github.com/MaksimDzhangirov/three-dots/part14/internal/trainer/app/query"
	"github.com/MaksimDzhangirov/three-dots/part14/internal/trainer/domain/hour"
...
func NewDatesFirestoreRepository(firestoreClient *firestore.Client, factoryConfig hour.FactoryConfig) DatesFirestoreRepository {
	...
	return DatesFirestoreRepository{firestoreClient: firestoreClient, factoryConfig: factoryConfig}
}
...
// setDefaultAvailability добавляет недостающие часы в модель даты, заполняя их значением по умолчанию, если для них не были назначены тренировки
