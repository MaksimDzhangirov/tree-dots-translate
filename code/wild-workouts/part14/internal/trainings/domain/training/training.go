...
import (
	...
	commonerrors "github.com/MaksimDzhangirov/three-dots/part14/internal/common/errors"
...
// UnmarshalTrainingFromDatabase преобразует в Training из базы данных
//
// Функцию следует использовать только для преобразования из базы данных!
// Вы не можете использовать UnmarshalTrainingFromDatabase как конструктор - в этом случае предметная область может быть в неправильном состоянии!
