...
import (
	...
	"github.com/MaksimDzhangirov/three-dots/part13/internal/common/client"
	"github.com/MaksimDzhangirov/three-dots/part13/internal/common/genproto/users"
...
func TestCreateTraining(t *testing.T) {
	...
	usersHTTPClient := NewUserHTTPClient(t, attendeeJWT)

	usersGrpcClient, _, err := client.NewUsersClient()
	require.NoError(t, err)

	// Отменяем тренировку, если существует, и делаем час доступным
