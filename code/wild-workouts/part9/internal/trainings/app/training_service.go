...
import (
	...
	"github.com/MaksimDzhangirov/three-dots/part9/internal/common/auth"
	commonerrors "github.com/MaksimDzhangirov/three-dots/part9/internal/common/errors"
...
type trainingRepository interface {
	...
	CancelTraining(ctx context.Context, trainingUUID string, deleteFn func(training Training) error) error
	RescheduleTraining(ctx context.Context, trainingUUID string, newTime time.Time, updateFn func(training Training) (Training, error)) error
	ApproveTrainingReschedule(ctx context.Context, trainingUUID string, updateFn func(training Training) (Training, error)) error
